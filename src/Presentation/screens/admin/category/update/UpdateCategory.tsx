...
import  UpdateCategoryViewModel  from './ViewModel'; // Import the hook
...
export const CategoriesCreateScreen = ({ navigation }: Props) => {
    const { 
        ...
        onChange, 
        errorMessages, 
        errorsResponse } = UpdateCategoryViewModel(); // Call the hook to get loading state and createCategory function
        ...
        <View style={styles.container}>
          ...
          <CustomTextInput
            ...
            <RoundedButton
                ...
                onPress={updateCategory} // Invoke the function to create a category
            />
            </View>
            {loading && (
